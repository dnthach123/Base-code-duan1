                    ...
                    <div class="card card-primary">
                        ...
                        <form action="<?= BASE_URL_ADMIN . '?act=them-san-pham' ?>" method="POST" enctype="multipart/form-data">
                            <div class="row card-body">
                                ...
                                <div class="form-group col-6">
                                    <label>Giá khiến mãi</label>
                                    <input type="number" class="form-control" name="gia_khuyen_mai" placeholder="Nhập giá khiến mãi">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control" name="so_luong" placeholder="Nhập giá khiến mãi">
